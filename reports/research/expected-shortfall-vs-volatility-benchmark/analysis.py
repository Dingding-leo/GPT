...
RESAMPLES = 2_000
CONFIDENCE = 0.95
SEEDS = {"BTC-USDT": 2026072317, "ETH-USDT": 2026072318}
CANONICAL_SIGNATURE = (
    "expected-shortfall-vs-volatility-benchmark-v1|"
    "markets=BTC-USDT,ETH-USDT|source=persisted-net-rolling-oos-returns|"
    "benchmark=volatility-targeted-long|metric=mean-worst-ceil-5pct-returns|"
    "tail-fraction=0.05|claim=strategy-minus-benchmark-expected-shortfall>0-"
    ...
    "seeds=BTC-USDT:2026072317,ETH-USDT:2026072318|candidate_count=1"
)
...
def bootstrap_expected_shortfall_delta(
    ...
    *,
    ...
    observed = expected_shortfall_delta(
        strategy,
        benchmark,
    ...
    for index in range(resamples):
        ...
        sample = expected_shortfall_delta(
...
def build_result(artifact_dir: str | Path) -> dict[str, object]:
    ...
    if failed_markets:
        rejection_reason = (
            ...
            "volatility-targeted-long expected-shortfall delta was non-positive in: "
            + ", ".join(failed_markets)
        )
    ...
    return {
        ...
        "provenance": {
            ...
            "market_type": "spot",
            "timeframe": "1Dutc",
            "source_workflow_run_id": 29977584146,
            "source_artifact_id": 8552001681,
            "source_artifact_name": "quant-research-source-218-final",
            "source_artifact_sha256": (
                "e875970e048fdb6eb1a946330a8229ac445378a165c196de5e88abdde4b14576"
            ),
            "source_code_commit": "0aeb79ba909be8b8be8e07f4c11b1f2b0fd32cec",
            "source_main_base": "1396124ff04da6dc28d7020945d315e0c61a7a82",
        },
    }
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Compare strategy and volatility-targeted-long expected shortfall."
    )
