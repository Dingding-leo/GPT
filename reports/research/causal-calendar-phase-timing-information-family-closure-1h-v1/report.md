...
Next: close `causal-lagged-btc-entry-gating-family-closure-1h-v1` using only the completed terminal records from issue/PR pairs #622/#623, #658/#659 and #661/#662. Treat the three materially distinct exogenous-entry mechanisms as architecture groups, consume no new candles or OOS, and require bilateral benchmark-relative timing support in at least two groups plus leave-one-group-out stability. This supersedes another BTC-impulse candidate because the exact stress-veto architecture was already tested and rejected.
