...
CANONICAL_SIGNATURE = (
    "volatility-matched-expected-shortfall-vs-buy-and-hold-v1|"
    "markets=BTC-USDT,ETH-USDT|source=persisted-net-rolling-oos-returns|"
    "benchmark=buy-and-hold-scaled-per-sample-to-strategy-sample-volatility|"
...
def build_result(artifact_dir: str | Path) -> dict[str, object]:
    ...
    if failed_markets:
        rejection_reason = (
            ...
            "volatility-matched-buy-and-hold expected-shortfall delta was non-positive in: "
            + ", ".join(failed_markets)
        )
    ...
    return {
        ...
        "hypothesis": (
            ...
            "after buy-and-hold is scaled to the strategy's sample volatility in both "
        ...
        "settings": {
            "benchmark": "buy-and-hold scaled to strategy sample volatility",
        ...
        "provenance": {
            ...
            "market_type": "spot",
            "timeframe": "1Dutc",
            "source_workflow_run_id": 29976177263,
            "source_artifact_id": 8551491583,
            "source_artifact_name": "quant-research-source-1580-attempt-1",
            "source_artifact_sha256": (
                "dc86c60ecff638ca3d9b6419e3d562391462588daec7466f64445168781c95ea"
            ),
            "source_code_commit": "d9591ce1ba4d378f60cfc52e645ca8bd94442738",
            "source_main_base": "2baa7cd6418184ca42fe7802f9e34b809476db1b",
            "expected_return_file_sha256": EXPECTED_RETURN_FILE_SHA256,
            "development_markets": list(MARKETS),
        },
        "claim_scope": (
            "Development-market tail-shape diagnostic only; a rejected result means the raw "
            "expected-shortfall reduction versus buy-and-hold is not shown to survive simple "
            "sample-volatility matching."
        ),
    }
