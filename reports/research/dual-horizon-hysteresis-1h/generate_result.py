...
def compact_result(result: dict) -> dict:
    ...
    for market, details in result["markets"].items():
        markets[market] = {
            ...
            "month_stability": {
                key: value for key, value in details["month_stability"].items() if key != "records"
            },
            "year_stability": {
                key: value for key, value in details["year_stability"].items() if key != "records"
            },
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    result = compact_result(build_result(arguments.btc_artifact_dir, arguments.eth_artifact_dir))
