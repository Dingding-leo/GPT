...
_EXPECTED_SHA256 = {
    ...
    "coverage-manifest.json": ("faa00e467091d3abf90d2fc5e4df2a516f8c7d256d489fde09ba0f5a67a40013"),
}
...
def main() -> None:
    ...
    if args.worker and (args.instrument is None or args.mode is None):
