...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Replay immutable public OKX instrument and top-of-book evidence."
    )
    parser.add_argument(
        "--output-dir",
        type=Path,
...
def main() -> int:
    ...
    summary = {
        ...
        "paper_order_blockers": [
            ...
            "submission_time_quantity_gate_not_invoked",
        ...
        "quote": {
            ...
            "exchange_observed_at_utc": _format_utc(quote_observation.exchange_time_observed_utc),
            "fixture_scope": (
