...
import gpt_quant.paper_execution_attempt_journal as attempt_journal_module
...
def test_replay_blocks_concurrent_paper_attempt_publication(
    tmp_path: Path,
    ...
    initial = record_paper_execution_attempt_evidence(
        path,
        first_attempt,
        intent_journal=intent_journal,
        quote_store=quote_store,
    ...
    original_read = attempt_journal_module._read_private_journal
    ...
    def replay() -> None:
        try:
            replay_result["journal"] = load_paper_execution_attempt_journal(
                path,
                intent_journal=intent_journal,
                quote_store=quote_store,
                binding_journal=binding_journal,
