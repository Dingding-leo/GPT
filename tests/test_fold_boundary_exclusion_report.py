...
ANALYSIS_PATH = REPOSITORY_ROOT / "reports" / "research" / "fold-boundary-exclusion" / "analysis.py"
RESULT_PATH = REPOSITORY_ROOT / "reports" / "research" / "fold-boundary-exclusion" / "result.json"
FIXTURE_PATH = (
