...
def test_live_trade_flow_source_schema_checkpoint() -> None:
    ...
    assert chronology["verdict"] == "trade_flow_numeric_id_chronology_proven_by_rest_sequence"
    for market in chronology["markets"]:
        ...
        assert market["alternative_descending_tie_break_changed_hours"] > 0
        assert market["hour_count"] == 24
