...
import run_prospective_simple_trend_shadow_0600 as prior
import run_prospective_simple_trend_shadow_1800 as base

HOUR_MS = prior.HOUR_MS
PREVIOUS_DECISION_HOUR_MS = 1_785_297_600_000  # 2026-07-29T04:00:00Z
REALIZED_DECISION_HOUR_MS = 1_785_301_200_000  # 2026-07-29T05:00:00Z
PRIOR_REPORTED_SIGNAL_HOUR_MS = 1_785_304_800_000  # 2026-07-29T06:00:00Z
LATEST_COMPLETE_SIGNAL_HOUR_MS = 1_785_308_400_000  # 2026-07-29T07:00:00Z
RECENT_WINDOW_FIRST_DECISION_HOUR_MS = 1_785_286_800_000  # 2026-07-29T01:00:00Z
RECENT_WINDOW_LAST_DECISION_HOUR_MS = REALIZED_DECISION_HOUR_MS
PRIOR_RESULT_SHA256 = "3aa3bd1c88acfc753482dc9a0b9974a4bfcd275adf0fe4d7011cc3cd90203020"
PRIOR_ARTIFACT_SHA256 = "5d5438410035fd9cde6cd51dad186ff2a4f38e159488e54fecc60aeb1152e6ca"
...
def write_report(output_dir: Path, result: dict[str, Any]) -> None:
    ...
    lines.extend(
        [
            ...
            "",
            "Issue #608's multi-horizon directional-consensus calibration architecture is "
            "terminally rejected on historical development evidence and remains "
            "prospectively unscored. The current update evaluates only the immutable "
            "benchmark-shadow policy and cannot rescue or promote the rejected family.",
            "",
...
def run(output_dir: Path, base_url: str) -> dict[str, Any]:
    ...
    result["window"]["prior_cumulative_realized_hours"] = 509
    result["window"]["updated_cumulative_realized_hours"] = 510
    result["nomination_status"] = (
        "no_statistically_eligible_strategy_after_multi_horizon_consensus_rejection"
    )
    result["active_alpha_context"] = {
        "issue": 608,
        "family_id": "multi-horizon-directional-consensus-calibration-1h-v1",
    ...
    result["next_strategy_action"] = (
        ...
        "public 1H observation; separately preregister one materially orthogonal "
        "own-history-only trend-break recovery architecture before development inspection"
    )
