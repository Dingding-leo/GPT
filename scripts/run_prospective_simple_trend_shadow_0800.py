...
import run_prospective_simple_trend_shadow_0700 as prior
import run_prospective_simple_trend_shadow_1800 as base

HOUR_MS = prior.HOUR_MS
PREVIOUS_DECISION_HOUR_MS = 1_785_301_200_000  # 2026-07-29T05:00:00Z
REALIZED_DECISION_HOUR_MS = 1_785_304_800_000  # 2026-07-29T06:00:00Z
PRIOR_REPORTED_SIGNAL_HOUR_MS = 1_785_308_400_000  # 2026-07-29T07:00:00Z
LATEST_COMPLETE_SIGNAL_HOUR_MS = 1_785_312_000_000  # 2026-07-29T08:00:00Z
RECENT_WINDOW_FIRST_DECISION_HOUR_MS = 1_785_290_400_000  # 2026-07-29T02:00:00Z
RECENT_WINDOW_LAST_DECISION_HOUR_MS = REALIZED_DECISION_HOUR_MS
PRIOR_RESULT_SHA256 = "1190ac6df73244c8fdc382008574189b0193d2d3bf1b79da8e91be28b3640de1"
PRIOR_ARTIFACT_SHA256 = "50786863a61480c05e86e95bb660d0c779392c488418bb315592fdd0eab67631"
...
def write_report(output_dir: Path, result: dict[str, Any]) -> None:
    ...
    lines.extend(
        [
            ...
            "",
            "Issue #611's trend-break path-recovery architecture is terminally rejected "
            "on historical development evidence and remains prospectively unscored. "
            "This update evaluates only the immutable benchmark-shadow policy and cannot "
            "rescue or promote the rejected family.",
            "",
...
def run(output_dir: Path, base_url: str) -> dict[str, Any]:
    ...
    result["window"]["prior_cumulative_realized_hours"] = 510
    result["window"]["updated_cumulative_realized_hours"] = 511
    result["nomination_status"] = (
        "no_statistically_eligible_strategy_after_trend_break_path_recovery_rejection"
    )
    result["active_alpha_context"] = {
        "issue": 611,
        "family_id": "trend-break-path-recovery-1h-v1",
    ...
    result["next_strategy_action"] = (
        ...
        "public 1H observation; separately preregister one own-history-only "
        "volatility-compression trend-acceleration architecture before development inspection"
    )
