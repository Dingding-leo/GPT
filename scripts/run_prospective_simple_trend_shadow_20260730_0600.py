...
import run_prospective_simple_trend_shadow_20260730_0500 as prior

HOUR_MS = prior.HOUR_MS
PREVIOUS_DECISION_HOUR_MS = 1_785_380_400_000  # 2026-07-30T03:00:00Z
REALIZED_DECISION_HOUR_MS = 1_785_384_000_000  # 2026-07-30T04:00:00Z
PRIOR_REPORTED_SIGNAL_HOUR_MS = 1_785_387_600_000  # 2026-07-30T05:00:00Z
LATEST_COMPLETE_SIGNAL_HOUR_MS = 1_785_391_200_000  # 2026-07-30T06:00:00Z
RECENT_WINDOW_FIRST_DECISION_HOUR_MS = 1_785_369_600_000  # 2026-07-30T00:00:00Z
RECENT_WINDOW_LAST_DECISION_HOUR_MS = REALIZED_DECISION_HOUR_MS
PRIOR_RESULT_SHA256 = "e30be7c507548f0eef54c3b19b81e04e4b77d8397e835511806f9b7647094804"
PRIOR_ARTIFACT_SHA256 = "c2362fa4db7dd6571640b7b40a66e9c809342a7750106b6893487376dd7ab45a"
...
def write_report(output_dir: Path, result: dict[str, Any]) -> None:
    lines = [
        "# Prospective simple-trend shadow update through 06:00 UTC",
        "",
    ...
    lines.extend(
        [
            ...
            "",
            "Issue #682 and open draft PR #683 record terminal historical rejection evidence for "
            "the bounded recovery re-entry after loss-budget exit family. This interval was not "
            "used to score, revise or rescue that family.",
            "",
...
def run(output_dir: Path, base_url: str) -> dict[str, Any]:
    ...
    result["window"]["prior_cumulative_realized_hours"] = 532
    result["window"]["updated_cumulative_realized_hours"] = 533
    result["nomination_status"] = "no_statistically_eligible_frozen_strategy"
    result["active_alpha_context"] = {
        "issue": 682,
        "pull_request": 683,
        "family_id": "bounded-recovery-reentry-loss-budget-1h-v1",
        "status": "terminal_historical_rejection_evidence_open_draft",
        "prospective_performance_consumed": False,
        "reason": (
            "the sole preregistered own-history bounded recovery candidate did not transport "
            "bilaterally: BTC's only OOS re-entry restored a harmful interval and reduced the "
            "irreversible comparator, while ETH's only re-entry restored profitable continuation "
            "but failed turnover efficiency, fold and year breadth, residual-Sharpe and both "
            "dependence-aware uncertainty gates; all restored exposure in each market came from "
            "one event, so this forward interval cannot alter its recovery threshold, horizon, "
            "re-entry count, loss budget, cadence, fee model or market treatment"
        ),
    }
    ...
    result["next_strategy_action"] = (
        ...
        "public 1H observation; do not prospectively rescue the rejected bounded recovery "
        "re-entry after loss-budget exit family"
    )
