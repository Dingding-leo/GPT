...
import run_prospective_simple_trend_shadow_20260729_2000 as prior

HOUR_MS = prior.HOUR_MS
PREVIOUS_DECISION_HOUR_MS = 1_785_348_000_000  # 2026-07-29T18:00:00Z
REALIZED_DECISION_HOUR_MS = 1_785_351_600_000  # 2026-07-29T19:00:00Z
PRIOR_REPORTED_SIGNAL_HOUR_MS = 1_785_355_200_000  # 2026-07-29T20:00:00Z
LATEST_COMPLETE_SIGNAL_HOUR_MS = 1_785_358_800_000  # 2026-07-29T21:00:00Z
RECENT_WINDOW_FIRST_DECISION_HOUR_MS = 1_785_337_200_000  # 2026-07-29T15:00:00Z
RECENT_WINDOW_LAST_DECISION_HOUR_MS = REALIZED_DECISION_HOUR_MS
PRIOR_RESULT_SHA256 = "83d26027cd7bc075020b81a0d9dfbe938d0099d7d93db52a74f636b99e07d687"
PRIOR_ARTIFACT_SHA256 = "f7191e3ebc488a0025d0034eca9867a5bb37effa30ebc264ac3b39035be6a130"
...
def write_report(output_dir: Path, result: dict[str, Any]) -> None:
    ...
    lines.extend(
        [
            ...
            "",
            "Issue #655 and draft PR #656 record terminal historical rejection evidence for "
            "the robust close-location pressure entry family. This interval was not used to "
...
def run(output_dir: Path, base_url: str) -> dict[str, Any]:
    ...
    result["window"]["prior_cumulative_realized_hours"] = 523
    result["window"]["updated_cumulative_realized_hours"] = 524
    ...
    result["active_alpha_context"] = {
        ...
        "reason": (
            "the preregistered entry filter reduced turnover and drawdown but failed bilateral "
            "return, Sharpe, fold-breadth, residual-Sharpe and paired-block uncertainty gates; "
            "this forward interval cannot be used for threshold or window rescue"
        ),
    }
    ...
    result["next_strategy_action"] = (
        ...
        "public 1H observation; do not prospectively rescue the rejected robust "
        "close-location pressure entry family"
    )
