...
import run_prospective_simple_trend_shadow_20260802_0500 as prior

PREVIOUS_DECISION_HOUR_MS = 1_785_639_600_000
REALIZED_DECISION_HOUR_MS = 1_785_643_200_000
PRIOR_REPORTED_SIGNAL_HOUR_MS = 1_785_643_200_000
LATEST_COMPLETE_SIGNAL_HOUR_MS = 1_785_646_800_000
RECENT_WINDOW_FIRST_DECISION_HOUR_MS = 1_785_628_800_000
RECENT_WINDOW_LAST_DECISION_HOUR_MS = REALIZED_DECISION_HOUR_MS
PAYOFF_END_OPEN_HOUR_MS = 1_785_650_400_000
PRIOR_RESULT_SHA256 = "9e6972b8a1803eeacd52c13d688363d9a98a9dd0f211276f8750c4be0feebb0b"
PRIOR_ARTIFACT_SHA256 = "cccb347bb6083c15b0056be6148cc54f62558fab1bf144c66ba879b668685b2a"
...
def write_outputs(output_dir: Path, result: dict[str, Any]) -> None:
    ...
    lines = [
        "# Prospective simple-trend checkpoint through 06:00 UTC on 2 August 2026",
        "",
    ...
    lines.extend(
        [
            ...
            "",
            "The 05:00 signal bar was provider-confirmed and updated the frozen 2,160H state. "
            "The 06:00 candle supplied only its already-fixed open as the end of the 05:00–06:00 "
...
def run(output_dir: Path, base_url: str) -> dict[str, Any]:
    ...
    result["window"]["prior_cumulative_realized_hours"] = 604
    result["window"]["updated_cumulative_realized_hours"] = 605
    result["performance_accessed"] = False
    result["oos_accessed"] = False
    result["machine_readable_verdict"]["updated_cumulative_realized_hours"] = 605
    result["machine_readable_verdict"]["payoff_end_open_timestamp"] = (
        prior.prior.prior.engine.iso_utc(PAYOFF_END_OPEN_HOUR_MS)
    )
    ...
    result["checkpoint_replication"] = {
        ...
        "prior_pull_request": 952,
        "prior_workflow_run": 30733831912,
        "prior_artifact_id": 8828833105,
