...
import run_prospective_simple_trend_shadow_20260730_0000 as prior

HOUR_MS = prior.HOUR_MS
PREVIOUS_DECISION_HOUR_MS = 1_785_362_400_000  # 2026-07-29T22:00:00Z
REALIZED_DECISION_HOUR_MS = 1_785_366_000_000  # 2026-07-29T23:00:00Z
PRIOR_REPORTED_SIGNAL_HOUR_MS = 1_785_369_600_000  # 2026-07-30T00:00:00Z
LATEST_COMPLETE_SIGNAL_HOUR_MS = 1_785_373_200_000  # 2026-07-30T01:00:00Z
RECENT_WINDOW_FIRST_DECISION_HOUR_MS = 1_785_351_600_000  # 2026-07-29T19:00:00Z
RECENT_WINDOW_LAST_DECISION_HOUR_MS = REALIZED_DECISION_HOUR_MS
PRIOR_RESULT_SHA256 = "36542596086825ba2920f44126c028ab561d633a4e888b16980f5993f175bbaa"
PRIOR_ARTIFACT_SHA256 = "398527aa75ec04aaa3bdb0144648b94fd58f330ded107491395230febd4e65fd"
...
def write_report(output_dir: Path, result: dict[str, Any]) -> None:
    ...
    lines.extend(
        [
            ...
            "",
            "Issue #667 and draft PR #668 record terminal historical rejection evidence for "
            "the downside-semivariance persistence risk-state sizing family. This interval was "
...
def run(output_dir: Path, base_url: str) -> dict[str, Any]:
    ...
    result["window"]["prior_cumulative_realized_hours"] = 527
    result["window"]["updated_cumulative_realized_hours"] = 528
    ...
    result["active_alpha_context"] = {
        ...
        "reason": (
            "the preregistered own-history partial-risk state did not transport economically "
            "across the two development markets: it removed positive carry in BTC, improved "
            "ETH point estimates without sufficient fold breadth or uncertainty support, "
            "increased turnover versus B1 in both markets, and reduced edge per turnover; "
            "therefore this forward interval cannot be used to change its windows, fraction, "
            "inequalities, hysteresis, cadence, fee model or market treatment"
        ),
    }
    ...
    result["next_strategy_action"] = (
        ...
        "public 1H observation; do not prospectively rescue the rejected downside-semivariance "
        "persistence risk-state sizing family"
    )
