...
import run_prospective_simple_trend_shadow_20260730_0100 as prior

HOUR_MS = prior.HOUR_MS
PREVIOUS_DECISION_HOUR_MS = 1_785_366_000_000  # 2026-07-29T23:00:00Z
REALIZED_DECISION_HOUR_MS = 1_785_369_600_000  # 2026-07-30T00:00:00Z
PRIOR_REPORTED_SIGNAL_HOUR_MS = 1_785_373_200_000  # 2026-07-30T01:00:00Z
LATEST_COMPLETE_SIGNAL_HOUR_MS = 1_785_376_800_000  # 2026-07-30T02:00:00Z
RECENT_WINDOW_FIRST_DECISION_HOUR_MS = 1_785_355_200_000  # 2026-07-29T20:00:00Z
RECENT_WINDOW_LAST_DECISION_HOUR_MS = REALIZED_DECISION_HOUR_MS
PRIOR_RESULT_SHA256 = "a6f48d698bb3f0d5bfd490a860598223bc5fffea0e6dc8b88120e557ad9f5b1a"
PRIOR_ARTIFACT_SHA256 = "908a4678b65f93090eab6bf29a42ba447638eb3ffc283632b1562d596117e0c7"
...
def write_report(output_dir: Path, result: dict[str, Any]) -> None:
    ...
    lines.extend(
        [
            ...
            "",
            "Issue #670 and draft PR #671 record terminal historical rejection evidence for "
            "the bipower-jump-concentration trend-carry sizing family. This interval was not "
...
def run(output_dir: Path, base_url: str) -> dict[str, Any]:
    ...
    result["window"]["prior_cumulative_realized_hours"] = 528
    result["window"]["updated_cumulative_realized_hours"] = 529
    ...
    result["active_alpha_context"] = {
        ...
        "reason": (
            ...
            "across the two development markets: half-exposure hours retained positive carry, "
            "incremental turnover and fees reduced efficiency, trigger frequency drifted lower "
            "OOS, and bilateral fold-breadth and uncertainty gates failed; therefore this "
            "forward interval cannot be used to change its horizons, estimator, fraction, "
            "inequalities, cadence, fee model or market treatment"
        ),
    }
    ...
    result["next_strategy_action"] = (
        ...
        "public 1H observation; do not prospectively rescue the rejected bipower-jump-"
        "concentration trend-carry sizing family"
    )
