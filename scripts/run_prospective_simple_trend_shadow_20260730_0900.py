...
import run_prospective_simple_trend_shadow_20260730_0800 as prior

HOUR_MS = prior.HOUR_MS
PREVIOUS_DECISION_HOUR_MS = 1_785_391_200_000  # 2026-07-30T06:00:00Z
REALIZED_DECISION_HOUR_MS = 1_785_394_800_000  # 2026-07-30T07:00:00Z
PRIOR_REPORTED_SIGNAL_HOUR_MS = 1_785_398_400_000  # 2026-07-30T08:00:00Z
LATEST_COMPLETE_SIGNAL_HOUR_MS = 1_785_402_000_000  # 2026-07-30T09:00:00Z
RECENT_WINDOW_FIRST_DECISION_HOUR_MS = 1_785_380_400_000  # 2026-07-30T03:00:00Z
RECENT_WINDOW_LAST_DECISION_HOUR_MS = REALIZED_DECISION_HOUR_MS
PRIOR_RESULT_SHA256 = "338780c91e62ca44c65d9db8575ca569a7cd21d53cd742728aa070c4d2a0d4b0"
PRIOR_ARTIFACT_SHA256 = "fe6f167ffef6a4f37539ad5729b5fc7b9d3e5906f5149bac55f40a51b9e6a224"
...
def write_report(output_dir: Path, result: dict[str, Any]) -> None:
    lines = [
        "# Prospective simple-trend shadow update through 09:00 UTC",
        "",
    ...
    lines.extend(
        [
            ...
            "",
            "Issue #691 and draft PR #692 record terminal historical rejection evidence for "
            "the exact directional-movement trend-quality risk-state family. This interval was "
            "not used to score, revise or rescue that family.",
            "",
...
def run(output_dir: Path, base_url: str) -> dict[str, Any]:
    ...
    result["window"]["prior_cumulative_realized_hours"] = 535
    result["window"]["updated_cumulative_realized_hours"] = 536
    result["nomination_status"] = "no_statistically_eligible_frozen_strategy"
    result["strategy_facing_discrepancy"] = diagnose_one_discrepancy(result)
    result["active_alpha_context"] = {
        "issue": 691,
        "pull_request": 692,
        "family_id": "exact-directional-movement-trend-quality-risk-state-1h-v1",
        "status": "terminal_historical_rejection_evidence_draft",
        "prospective_performance_consumed": False,
        "reason": (
            "the sole preregistered own-history directional-movement quality state reduced "
            "exposure after negative and deteriorating 720H Wilder directional balance, but "
            "BTC scaling removed positive continuation carry and ETH's favourable aggregate "
            "point estimate remained sequencing-dependent; both markets failed turnover and "
            "edge-per-turnover requirements, profitable-fold breadth, residual-Sharpe and "
            "dependence-aware uncertainty lower bounds, so this forward interval cannot alter "
            "the directional horizon, comparison windows, exposure fraction, state logic, "
    ...
    result["next_strategy_action"] = (
        ...
        "public 1H observation; do not prospectively rescue the rejected exact "
        "directional-movement trend-quality risk-state family"
    )
