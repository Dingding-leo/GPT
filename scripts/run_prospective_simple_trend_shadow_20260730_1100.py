...
import run_prospective_simple_trend_shadow_20260730_1000 as prior

HOUR_MS = prior.HOUR_MS
PREVIOUS_DECISION_HOUR_MS = 1_785_398_400_000  # 2026-07-30T08:00:00Z
REALIZED_DECISION_HOUR_MS = 1_785_402_000_000  # 2026-07-30T09:00:00Z
PRIOR_REPORTED_SIGNAL_HOUR_MS = 1_785_405_600_000  # 2026-07-30T10:00:00Z
LATEST_COMPLETE_SIGNAL_HOUR_MS = 1_785_409_200_000  # 2026-07-30T11:00:00Z
RECENT_WINDOW_FIRST_DECISION_HOUR_MS = 1_785_387_600_000  # 2026-07-30T05:00:00Z
RECENT_WINDOW_LAST_DECISION_HOUR_MS = REALIZED_DECISION_HOUR_MS
PRIOR_RESULT_SHA256 = "0121a637ca68896d9ec021cfe3ecfd74e2849737fa91a3982fa7cbaa13b7a14d"
PRIOR_ARTIFACT_SHA256 = "31ec2d2961366c9e1306b9c7a37fcdea41d8f0dc6de0cf88a46a8b84c5dc305"
...
def write_report(output_dir: Path, result: dict[str, Any]) -> None:
    lines = [
        "# Prospective simple-trend shadow update through 11:00 UTC",
        "",
    ...
    lines.extend(
        [
            ...
            "## Correction protocol",
            "",
            f"- Correction permitted: `{result['training_authorized_correction']['permitted']}`",
            f"- Correction applied: `{result['training_authorized_correction']['applied']}`",
            "- Policy changed: `false`",
            "- Observation epoch restarted: `false`",
            "",
            "Issue #697 and closed unmerged PR #698 contain terminal historical rejection "
            "evidence for the exact bounded upper-wick rejection-pause family. BTC pauses "
            "systematically removed profitable continuation; ETH's useful warning decayed well "
            "before the fixed 168H pause ended. This prospective interval was not consumed to "
...
def run(output_dir: Path, base_url: str) -> dict[str, Any]:
    ...
    result["window"]["prior_cumulative_realized_hours"] = 537
    result["window"]["updated_cumulative_realized_hours"] = 538
    ...
    result["active_alpha_context"] = {
        ...
        "reason": (
            "BTC's eight development-OOS pauses removed positive 168H continuation and added "
            "turnover; ETH's five pauses captured only short-lived weakness and outlasted the "
            "warning. Both markets failed bilateral breadth, turnover-efficiency and "
            "dependence-aware uncertainty gates, so no same-interval rescue is authorised."
        ),
    }
    ...
    result["next_strategy_action"] = (
        ...
        "1H observation; do not prospectively rescue the rejected bounded upper-wick "
        "rejection-pause family"
    )
