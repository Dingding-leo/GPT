...
import run_prospective_simple_trend_shadow_20260730_1500 as prior

HOUR_MS = prior.HOUR_MS
PREVIOUS_DECISION_HOUR_MS = 1_785_416_400_000  # 2026-07-30T13:00:00Z
REALIZED_DECISION_HOUR_MS = 1_785_420_000_000  # 2026-07-30T14:00:00Z
PRIOR_REPORTED_SIGNAL_HOUR_MS = 1_785_423_600_000  # 2026-07-30T15:00:00Z
LATEST_COMPLETE_SIGNAL_HOUR_MS = 1_785_427_200_000  # 2026-07-30T16:00:00Z
RECENT_WINDOW_FIRST_DECISION_HOUR_MS = 1_785_405_600_000  # 2026-07-30T10:00:00Z
RECENT_WINDOW_LAST_DECISION_HOUR_MS = REALIZED_DECISION_HOUR_MS
PRIOR_RESULT_SHA256 = "e5f1bf57237c4c102fc7c9b30b72f7a0752d0735e500f039c6720c6f2a344936"
PRIOR_ARTIFACT_SHA256 = "f83761f8049be063132b7ccbce0298e221a387b8e97b96ccf4c2b9c081b83b20"
...
def write_report(output_dir: Path, result: dict[str, Any]) -> None:
    ...
    lines.extend(
        [
            ...
            "",
            "Issue #722 and closed evidence PR #723 contain terminal historical rejection evidence for the exact two-tap daily trend-state ensemble. It reduced transition turnover as intended, but underperformed the frozen daily benchmark on compounded return and Sharpe in both markets. BTC also worsened drawdown, both markets failed profitable-fold breadth, residual Sharpe was negative, and all dependence-aware uncertainty intervals crossed zero. This forward interval was not consumed to revise or rescue that family.",
            "",
...
def run(output_dir: Path, base_url: str) -> dict[str, Any]:
    ...
    result["window"]["prior_cumulative_realized_hours"] = 542
    result["window"]["updated_cumulative_realized_hours"] = 543
    ...
    result["active_alpha_context"] = {
        ...
        "reason": (
            "The exact temporal ensemble reduced turnover but underperformed B1 on compounded return and "
            "Sharpe in both markets. BTC worsened drawdown; both markets failed fold breadth, residual-Sharpe "
            "and dependence-aware uncertainty gates. No rescue or market-specific promotion is authorised."
        ),
    }
    ...
    result["next_strategy_action"] = (
        ...
        "1H observation; do not prospectively rescue the rejected two-tap daily trend-state ensemble family"
    )
