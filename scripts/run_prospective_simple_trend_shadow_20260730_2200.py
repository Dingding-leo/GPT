...
import run_prospective_simple_trend_shadow_20260730_2100 as prior

HOUR_MS = prior.HOUR_MS
PREVIOUS_DECISION_HOUR_MS = 1_785_438_000_000  # 2026-07-30T19:00:00Z
REALIZED_DECISION_HOUR_MS = 1_785_441_600_000  # 2026-07-30T20:00:00Z
PRIOR_REPORTED_SIGNAL_HOUR_MS = 1_785_445_200_000  # 2026-07-30T21:00:00Z
LATEST_COMPLETE_SIGNAL_HOUR_MS = 1_785_448_800_000  # 2026-07-30T22:00:00Z
RECENT_WINDOW_FIRST_DECISION_HOUR_MS = 1_785_427_200_000  # 2026-07-30T16:00:00Z
RECENT_WINDOW_LAST_DECISION_HOUR_MS = REALIZED_DECISION_HOUR_MS
PRIOR_RESULT_SHA256 = "94e057cc104441547a8ba6c09edf185dcbc51fc359db5469e2e742316a367e1f"
PRIOR_ARTIFACT_SHA256 = "12d6db1f9a57534dfdbbc58c14cc5fef39db924e43267fa2aa01735d6a031be1"
...
def write_report(output_dir: Path, result: dict[str, Any]) -> None:
    lines = [
        "# Prospective simple-trend shadow update through 22:00 UTC",
        "",
    ...
    lines.extend([
        ...
        "",
        "Issue #745 and closed evidence PR #746 contain terminal holdout rejection evidence for the exact feature-free neutral-prior expanding payoff-intercept sleeve. CFX improved versus B1 but remained negative in both OOS and full samples and lacked fold/year breadth; FIL selected adverse sleeves after an early positive payoff regime and materially underperformed B1. Both markets failed dependence-aware return and Sharpe uncertainty gates, and the common-block confidence intervals crossed zero. This forward interval was not consumed to revise or rescue that family.",
        "",
...
def run(output_dir: Path, base_url: str) -> dict[str, Any]:
    ...
    result["window"]["prior_cumulative_realized_hours"] = 548
    result["window"]["updated_cumulative_realized_hours"] = 549
    result["nomination_status"] = "no_statistically_eligible_frozen_strategy"
    result["active_alpha_context"] = {
        "issue": 745,
        "pull_request": 746,
        "family_id": "neutral-prior-expanding-payoff-intercept-sleeve-1h-v1",
        "status": "terminal_holdout_rejection_evidence_closed_unmerged",
        "prospective_performance_consumed": False,
        "reason": (
            "CFX improved versus B1 but the strategy architecture remained negative and lacked temporal breadth; "
            "FIL's expanding payoff intercept adapted too slowly to a reversal in sleeve economics and selected materially adverse carry. "
            "Both holdouts failed dependence-aware return and Sharpe uncertainty gates, and common-block intervals crossed zero. "
            "No same-cohort rescue, market filtering, or promotion is authorised."
        ),
    }
    ...
    result["next_strategy_action"] = (
        ...
        "do not prospectively rescue the rejected neutral-prior expanding payoff-intercept sleeve family"
    )
