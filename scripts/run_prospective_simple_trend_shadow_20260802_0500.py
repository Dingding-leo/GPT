...
import run_prospective_simple_trend_shadow_20260802_0400 as prior

PREVIOUS_DECISION_HOUR_MS = 1_785_636_000_000
REALIZED_DECISION_HOUR_MS = 1_785_639_600_000
PRIOR_REPORTED_SIGNAL_HOUR_MS = 1_785_639_600_000
LATEST_COMPLETE_SIGNAL_HOUR_MS = 1_785_643_200_000
RECENT_WINDOW_FIRST_DECISION_HOUR_MS = 1_785_625_200_000
RECENT_WINDOW_LAST_DECISION_HOUR_MS = REALIZED_DECISION_HOUR_MS
PAYOFF_END_OPEN_HOUR_MS = 1_785_646_800_000
PRIOR_RESULT_SHA256 = "e99c28d06f3d151393c3c3dbf5c6fa0dec7597326c87c9b9565b2647a5899a31"
PRIOR_ARTIFACT_SHA256 = "07745c6495c114d426beeef9d93e0dfd4da854d9edf09c49087cdf48a3fbf248"
...
def write_outputs(output_dir: Path, result: dict[str, Any]) -> None:
    ...
    lines = [
        "# Prospective simple-trend checkpoint through 05:00 UTC on 2 August 2026",
        "",
    ...
    lines.extend(
        [
            ...
            "",
            "The 04:00 signal bar was provider-confirmed and updated the frozen 2,160H state. "
            "The 05:00 candle supplied only its already-fixed open as the end of the 04:00–05:00 "
...
def run(output_dir: Path, base_url: str) -> dict[str, Any]:
    ...
    result["window"]["prior_cumulative_realized_hours"] = 603
    result["window"]["updated_cumulative_realized_hours"] = 604
    result["performance_accessed"] = False
    result["oos_accessed"] = False
    result["machine_readable_verdict"]["updated_cumulative_realized_hours"] = 604
    result["machine_readable_verdict"]["payoff_end_open_timestamp"] = prior.prior.engine.iso_utc(
        PAYOFF_END_OPEN_HOUR_MS
    )
    ...
    result["checkpoint_replication"] = {
        ...
        "prior_pull_request": 951,
        "prior_workflow_run": 30732714740,
        "prior_artifact_id": 8828491786,
