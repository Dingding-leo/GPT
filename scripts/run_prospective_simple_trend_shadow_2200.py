...
PREVIOUS_DECISION_HOUR_MS = 1_785_265_200_000  # 2026-07-28T19:00:00Z
REALIZED_DECISION_HOUR_MS = 1_785_268_800_000  # 2026-07-28T20:00:00Z
PRIOR_REPORTED_SIGNAL_HOUR_MS = 1_785_272_400_000  # 2026-07-28T21:00:00Z
LATEST_COMPLETE_SIGNAL_HOUR_MS = 1_785_276_000_000  # 2026-07-28T22:00:00Z
PRIOR_RESULT_SHA256 = "377d58c1f971c21f5b08085758af6d443d192b908e740df41c35596d86177725"
PRIOR_ARTIFACT_SHA256 = "c04c66d1cee294315728e0d42ac15303cab513284340f397e153216f552d5ee1"
...
def run(output_dir: Path, base_url: str) -> dict[str, Any]:
    ...
    result = {
        ...
        "nomination_status": "no_statistically_eligible_strategy_after_trade_flow_rejection",
        "bar": base.BAR,
        ...
        "window": {
            ...
            "prior_cumulative_realized_hours": 500,
            "updated_cumulative_realized_hours": 501,
        },
        ...
        "next_strategy_action": (
            ...
            "no strategy is nominated for paper or live use, and the next research "
            "architecture must be predeclared before development evidence is inspected"
        ),
    }
