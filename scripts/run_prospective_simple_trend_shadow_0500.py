...
import run_prospective_simple_trend_shadow_0400 as prior

HOUR_MS = prior.HOUR_MS
PREVIOUS_DECISION_HOUR_MS = 1_785_290_400_000  # 2026-07-29T02:00:00Z
REALIZED_DECISION_HOUR_MS = 1_785_294_000_000  # 2026-07-29T03:00:00Z
PRIOR_REPORTED_SIGNAL_HOUR_MS = 1_785_297_600_000  # 2026-07-29T04:00:00Z
LATEST_COMPLETE_SIGNAL_HOUR_MS = 1_785_301_200_000  # 2026-07-29T05:00:00Z
RECENT_WINDOW_FIRST_DECISION_HOUR_MS = 1_785_279_600_000  # 2026-07-28T23:00:00Z
RECENT_WINDOW_LAST_DECISION_HOUR_MS = REALIZED_DECISION_HOUR_MS
PRIOR_RESULT_SHA256 = "9dc9612bceb1dc3fdfed58ac88488c93fa8bac402c913585a372bafe97a51e8f"
PRIOR_ARTIFACT_SHA256 = "e6d4bf0e9ec9dc21fd8455eee949b6bdeac46a78d99d13440ac67266b104f4f7"
...
def write_report(output_dir: Path, result: dict[str, Any]) -> None:
    ...
    lines.extend(
        [
            ...
            "",
            "Issue #602's signed-tail-pressure architecture is terminally rejected on "
            "historical development evidence and remains prospectively unscored. The "
            "current forward update evaluates only the immutable benchmark-shadow policy "
            "and cannot rescue or promote the rejected family.",
            "",
...
def run(output_dir: Path, base_url: str) -> dict[str, Any]:
    ...
    result["window"]["prior_cumulative_realized_hours"] = 507
    result["window"]["updated_cumulative_realized_hours"] = 508
    result["nomination_status"] = (
        "no_statistically_eligible_strategy_after_signed_tail_pressure_rejection"
    )
    result["active_alpha_context"] = {
        "issue": 602,
        "family_id": "signed-tail-pressure-trend-1h-v1",
    ...
    result["next_strategy_action"] = (
        ...
        "observation; separately preregister one own-history-only causal return-sign "
        "transition change-point architecture before inspecting development performance"
    )
    prior.prior.prior.prior.base.write_outputs(output_dir, result)
