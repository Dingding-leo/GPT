...
import run_prospective_simple_trend_shadow_20260730_1300 as prior

HOUR_MS = prior.HOUR_MS
PREVIOUS_DECISION_HOUR_MS = 1_785_409_200_000  # 2026-07-30T11:00:00Z
REALIZED_DECISION_HOUR_MS = 1_785_412_800_000  # 2026-07-30T12:00:00Z
PRIOR_REPORTED_SIGNAL_HOUR_MS = 1_785_416_400_000  # 2026-07-30T13:00:00Z
LATEST_COMPLETE_SIGNAL_HOUR_MS = 1_785_420_000_000  # 2026-07-30T14:00:00Z
RECENT_WINDOW_FIRST_DECISION_HOUR_MS = 1_785_398_400_000  # 2026-07-30T08:00:00Z
RECENT_WINDOW_LAST_DECISION_HOUR_MS = REALIZED_DECISION_HOUR_MS
PRIOR_RESULT_SHA256 = "c0799ba5245d6fdf5c7135181d7c5763465256daefaaa565f7acafbec081c7ae"
PRIOR_ARTIFACT_SHA256 = "aae0477d8e7846c2c960621c9c30a83bac43556ad0c39eb5d51af520a7091303"
...
def write_report(output_dir: Path, result: dict[str, Any]) -> None:
    lines = [
        "# Prospective simple-trend shadow update through 14:00 UTC",
        "",
    ...
    lines.extend(
        [
            ...
            "",
            "Issue #712 and evidence PR #713 contain terminal historical rejection evidence for the exact renewal-supported base-exit bridge. BTC underperformed the frozen daily benchmark on return, Sharpe and drawdown and failed breadth and dependence-aware uncertainty gates. ETH's favourable point estimate was concentrated in only two rapidly restoring bridge events and still failed the preregistered fold-breadth and strictly-positive lower-bound requirements. This forward interval was not consumed to revise or rescue that family.",
            "",
...
def run(output_dir: Path, base_url: str) -> dict[str, Any]:
    ...
    result["window"]["prior_cumulative_realized_hours"] = 540
    result["window"]["updated_cumulative_realized_hours"] = 541
    result["nomination_status"] = "no_statistically_eligible_frozen_strategy"
    result["active_alpha_context"] = {
        "issue": 712,
        "pull_request": 713,
        "family_id": "renewal-supported-base-exit-bridge-1h-v1",
        "status": "terminal_historical_rejection_evidence_open_unmerged",
        "prospective_performance_consumed": False,
        "reason": (
            "BTC's four OOS bridges reduced benchmark performance and failed deterministic, breadth, "
            "and dependence-aware gates. ETH's positive bridge economics arose from only two events "
            "and did not satisfy fold breadth or strictly positive uncertainty lower bounds; no rescue "
            "or market-specific promotion is authorised."
        ),
    }
    ...
    result["next_strategy_action"] = (
        ...
        "1H observation; do not prospectively rescue the rejected renewal-supported base-exit "
        "bridge family"
    )
