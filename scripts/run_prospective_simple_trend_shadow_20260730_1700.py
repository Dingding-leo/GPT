...
import run_prospective_simple_trend_shadow_20260730_1600 as prior

HOUR_MS = prior.HOUR_MS
PREVIOUS_DECISION_HOUR_MS = 1_785_420_000_000  # 2026-07-30T14:00:00Z
REALIZED_DECISION_HOUR_MS = 1_785_423_600_000  # 2026-07-30T15:00:00Z
PRIOR_REPORTED_SIGNAL_HOUR_MS = 1_785_427_200_000  # 2026-07-30T16:00:00Z
LATEST_COMPLETE_SIGNAL_HOUR_MS = 1_785_430_800_000  # 2026-07-30T17:00:00Z
RECENT_WINDOW_FIRST_DECISION_HOUR_MS = 1_785_409_200_000  # 2026-07-30T11:00:00Z
RECENT_WINDOW_LAST_DECISION_HOUR_MS = REALIZED_DECISION_HOUR_MS
PRIOR_RESULT_SHA256 = "7577fc247b09326c431b0ede97465a750fc826a9164afe3e76ef61261cab5a78"
PRIOR_ARTIFACT_SHA256 = "c00333b63981d2e032c58e965560a260feabe4917ce0acb481486ab62e6656f8"
...
def write_report(output_dir: Path, result: dict[str, Any]) -> None:
    lines = [
        "# Prospective simple-trend shadow update through 17:00 UTC",
        "",
    ...
    lines.extend(
        [
            ...
            "",
            "Issue #725 and closed evidence PR #726 contain terminal historical rejection evidence for the exact spectral trend-quality irreversible downgrade. BTC materially underperformed the frozen daily benchmark on compounded return, Sharpe and edge per turnover. ETH improved aggregate return, Sharpe and drawdown only through sequencing, while failing edge per turnover, fold breadth, residual Sharpe and dependence-aware uncertainty. The irreversible half state removed profitable recovery carry in both markets. This forward interval was not consumed to revise or rescue that family.",
            "",
...
def run(output_dir: Path, base_url: str) -> dict[str, Any]:
    ...
    result["window"]["prior_cumulative_realized_hours"] = 543
    result["window"]["updated_cumulative_realized_hours"] = 544
    ...
    result["active_alpha_context"] = {
        ...
        "reason": (
            "BTC underperformed B1 on return, Sharpe and edge per turnover. ETH's favourable aggregate "
            "point estimates were sequencing effects and failed edge-per-turnover, fold-breadth, residual-"
            "Sharpe and dependence-aware uncertainty gates. The irreversible state removed profitable "
            "recovery carry; no spectral retuning or market-specific promotion is authorised."
        ),
    }
    ...
    result["next_strategy_action"] = (
        ...
        "1H observation; do not prospectively rescue the rejected spectral trend-quality irreversible downgrade family"
    )
