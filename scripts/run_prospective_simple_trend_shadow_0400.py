...
import run_prospective_simple_trend_shadow_0300 as prior

HOUR_MS = prior.HOUR_MS
PREVIOUS_DECISION_HOUR_MS = 1_785_286_800_000  # 2026-07-29T01:00:00Z
REALIZED_DECISION_HOUR_MS = 1_785_290_400_000  # 2026-07-29T02:00:00Z
PRIOR_REPORTED_SIGNAL_HOUR_MS = 1_785_294_000_000  # 2026-07-29T03:00:00Z
LATEST_COMPLETE_SIGNAL_HOUR_MS = 1_785_297_600_000  # 2026-07-29T04:00:00Z
RECENT_WINDOW_FIRST_DECISION_HOUR_MS = 1_785_276_000_000  # 2026-07-28T22:00:00Z
RECENT_WINDOW_LAST_DECISION_HOUR_MS = REALIZED_DECISION_HOUR_MS
PRIOR_RESULT_SHA256 = "e85561f325b38594d44045084cd06a64e0e3e93aa64b63c00957ec0b922c38da"
PRIOR_ARTIFACT_SHA256 = "2c691e10fdc57f1da0b780f683f8f750014c1b0808737ccf3ad2ee00d945b529"
...
def write_report(output_dir: Path, result: dict[str, Any]) -> None:
    ...
    lines.extend(
        [
            ...
            "",
            "Issue #599's Weibull duration-hazard architecture is terminally rejected on "
...
def run(output_dir: Path, base_url: str) -> dict[str, Any]:
    ...
    result["window"]["prior_cumulative_realized_hours"] = 506
    result["window"]["updated_cumulative_realized_hours"] = 507
    result["nomination_status"] = (
        "no_statistically_eligible_strategy_after_weibull_duration_hazard_rejection"
    )
    result["active_alpha_context"] = {
        "issue": 599,
        "family_id": "weibull-duration-hazard-continuation-1h-v1",
    ...
    result["next_strategy_action"] = (
        ...
        "observation; separately preregister one own-history-only causal downside-shock "
        "recovery architecture before inspecting development performance"
    )
    prior.prior.prior.base.write_outputs(output_dir, result)
