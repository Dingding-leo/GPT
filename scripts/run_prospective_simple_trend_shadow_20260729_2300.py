...
import run_prospective_simple_trend_shadow_20260729_2200 as prior

HOUR_MS = prior.HOUR_MS
PREVIOUS_DECISION_HOUR_MS = 1_785_355_200_000  # 2026-07-29T20:00:00Z
REALIZED_DECISION_HOUR_MS = 1_785_358_800_000  # 2026-07-29T21:00:00Z
PRIOR_REPORTED_SIGNAL_HOUR_MS = 1_785_362_400_000  # 2026-07-29T22:00:00Z
LATEST_COMPLETE_SIGNAL_HOUR_MS = 1_785_366_000_000  # 2026-07-29T23:00:00Z
RECENT_WINDOW_FIRST_DECISION_HOUR_MS = 1_785_344_400_000  # 2026-07-29T17:00:00Z
RECENT_WINDOW_LAST_DECISION_HOUR_MS = REALIZED_DECISION_HOUR_MS
PRIOR_RESULT_SHA256 = "9e25c129057f16d91dc9b85cfe7cd4599915360f3b945f838f517685cea51b73"
PRIOR_ARTIFACT_SHA256 = "cbb52189235a3809006c389b3f7302229ab369050d00808a6d74c107d8a4c29c"
...
def write_report(output_dir: Path, result: dict[str, Any]) -> None:
    lines = [
        "# Prospective simple-trend shadow update through 23:00 UTC",
        "",
    ...
    lines.extend(
        [
            ...
            "",
            "Issue #661 and draft PR #662 record terminal historical rejection evidence for "
            "the lagged BTC downside-shock absorption entry family. This interval was not used "
...
def run(output_dir: Path, base_url: str) -> dict[str, Any]:
    ...
    result["window"]["prior_cumulative_realized_hours"] = 525
    result["window"]["updated_cumulative_realized_hours"] = 526
    ...
    result["active_alpha_context"] = {
        ...
        "reason": (
            "the preregistered training-only support gate found only six daily state decisions, "
            "all generated by one underlying BTC shock, below the minimum support of twenty; "
            "the selector therefore failed closed to cash and this forward interval cannot be "
            "used to relax the shock, wick, age, recovery, support, cadence or exit rules"
        ),
    }
    ...
    result["next_strategy_action"] = (
        ...
        "public 1H observation; do not prospectively rescue the rejected lagged BTC "
        "downside-shock absorption entry family"
    )
