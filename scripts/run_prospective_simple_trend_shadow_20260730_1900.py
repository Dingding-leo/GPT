...
import run_prospective_simple_trend_shadow_20260730_1800 as prior

HOUR_MS = prior.HOUR_MS
PREVIOUS_DECISION_HOUR_MS = 1_785_427_200_000  # 2026-07-30T16:00:00Z
REALIZED_DECISION_HOUR_MS = 1_785_430_800_000  # 2026-07-30T17:00:00Z
PRIOR_REPORTED_SIGNAL_HOUR_MS = 1_785_434_400_000  # 2026-07-30T18:00:00Z
LATEST_COMPLETE_SIGNAL_HOUR_MS = 1_785_438_000_000  # 2026-07-30T19:00:00Z
RECENT_WINDOW_FIRST_DECISION_HOUR_MS = 1_785_416_400_000  # 2026-07-30T13:00:00Z
RECENT_WINDOW_LAST_DECISION_HOUR_MS = REALIZED_DECISION_HOUR_MS
PRIOR_RESULT_SHA256 = "69e7cf48f10f3844c4dc1513da3ba1d73907001d42917643207945f625d2b578"
PRIOR_ARTIFACT_SHA256 = "49ef875046a185f949725bc23f3a519ab3d64841755d825230f30d21e9d79b29"
...
def write_report(output_dir: Path, result: dict[str, Any]) -> None:
    lines = [
        "# Prospective simple-trend shadow update through 19:00 UTC",
        "",
    ...
    lines.extend([
        ...
        "",
        "Issue #733 and evidence PR #734 contain terminal historical rejection evidence for the exact trend drawdown recovery-efficiency checkpoint. The candidate improved aggregate return, Sharpe and drawdown in both markets, but added structural round trips, reduced edge per turnover, achieved only 5/12 BTC and 6/12 ETH profitable folds, and every dependence-aware lower confidence bound crossed zero. This forward interval was not consumed to revise or rescue that family.",
        "",
...
def run(output_dir: Path, base_url: str) -> dict[str, Any]:
    ...
    result["window"]["prior_cumulative_realized_hours"] = 545
    result["window"]["updated_cumulative_realized_hours"] = 546
    result["nomination_status"] = "no_statistically_eligible_frozen_strategy"
    result["active_alpha_context"] = {
        "issue": 733,
        "pull_request": 734,
        "family_id": "trend-drawdown-recovery-efficiency-checkpoint-1h-v1",
        "status": "terminal_historical_rejection_evidence_closed_unmerged",
        "prospective_performance_consumed": False,
        "reason": (
            "The bounded path-state checkpoint improved aggregate point estimates but added turnover, reduced edge per turnover, "
            "failed bilateral fold breadth, and lacked strictly positive dependence-aware lower confidence bounds. No retuning "
    ...
    result["next_strategy_action"] = (
        ...
        "do not prospectively rescue the rejected trend drawdown recovery-efficiency checkpoint family"
    )
