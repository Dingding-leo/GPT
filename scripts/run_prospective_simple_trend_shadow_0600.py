...
import run_prospective_simple_trend_shadow_0500 as prior
import run_prospective_simple_trend_shadow_1800 as base

HOUR_MS = prior.HOUR_MS
PREVIOUS_DECISION_HOUR_MS = 1_785_294_000_000  # 2026-07-29T03:00:00Z
REALIZED_DECISION_HOUR_MS = 1_785_297_600_000  # 2026-07-29T04:00:00Z
PRIOR_REPORTED_SIGNAL_HOUR_MS = 1_785_301_200_000  # 2026-07-29T05:00:00Z
LATEST_COMPLETE_SIGNAL_HOUR_MS = 1_785_304_800_000  # 2026-07-29T06:00:00Z
RECENT_WINDOW_FIRST_DECISION_HOUR_MS = 1_785_283_200_000  # 2026-07-29T00:00:00Z
RECENT_WINDOW_LAST_DECISION_HOUR_MS = REALIZED_DECISION_HOUR_MS
PRIOR_RESULT_SHA256 = "85fef14a6f29144da7f9ac439fe6be5ecf64b8500c583b780c6e29b0ca8f414b"
PRIOR_ARTIFACT_SHA256 = "26f2d42091ed16aad3ab51d93d69452e14e034f6a361aa095d3e19395b713ddc"
...
def write_report(output_dir: Path, result: dict[str, Any]) -> None:
    ...
    lines.extend(
        [
            ...
            "",
            "Issue #605's Bayesian sign-transition change-point architecture is "
            "terminally rejected on historical development evidence and remains "
            "prospectively unscored. The current forward update evaluates only the "
            "immutable benchmark-shadow policy and cannot rescue or promote the "
            "rejected family.",
            "",
...
def run(output_dir: Path, base_url: str) -> dict[str, Any]:
    ...
    result["window"]["prior_cumulative_realized_hours"] = 508
    result["window"]["updated_cumulative_realized_hours"] = 509
    result["nomination_status"] = (
        "no_statistically_eligible_strategy_after_sign_transition_change_point_rejection"
    )
    result["active_alpha_context"] = {
        "issue": 605,
        "family_id": "bayesian-sign-transition-change-point-1h-v1",
    ...
    result["historical_selection_relationship_status"] = {
        ...
        "reason": (
            ...
            if exposed
            else "a cash-only new interval supplies no realized conditional-long return and "
    ...
    result["next_strategy_action"] = (
        ...
        "observation; separately preregister one own-history-only multi-horizon "
        "directional-consensus calibration architecture before development inspection"
    )
