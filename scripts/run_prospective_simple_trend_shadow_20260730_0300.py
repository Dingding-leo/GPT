...
import run_prospective_simple_trend_shadow_20260730_0200 as prior

HOUR_MS = prior.HOUR_MS
PREVIOUS_DECISION_HOUR_MS = 1_785_369_600_000  # 2026-07-30T00:00:00Z
REALIZED_DECISION_HOUR_MS = 1_785_373_200_000  # 2026-07-30T01:00:00Z
PRIOR_REPORTED_SIGNAL_HOUR_MS = 1_785_376_800_000  # 2026-07-30T02:00:00Z
LATEST_COMPLETE_SIGNAL_HOUR_MS = 1_785_380_400_000  # 2026-07-30T03:00:00Z
RECENT_WINDOW_FIRST_DECISION_HOUR_MS = 1_785_358_800_000  # 2026-07-29T21:00:00Z
RECENT_WINDOW_LAST_DECISION_HOUR_MS = REALIZED_DECISION_HOUR_MS
PRIOR_RESULT_SHA256 = "8500309cb37d041df2c7db490b7039a97e5dee513c714027acbc1f364ea19ad5"
PRIOR_ARTIFACT_SHA256 = "9147ef7e7f70dcf17a40eeeb96b24b53a9f425dad8e844032c479696c6751a79"
...
def write_report(output_dir: Path, result: dict[str, Any]) -> None:
    ...
    lines.extend(
        [
            ...
            "",
            "Issue #673 and draft PR #674 record terminal historical rejection evidence for "
            "the signed-range compression-breakout entry family. This interval was not used "
...
def run(output_dir: Path, base_url: str) -> dict[str, Any]:
    ...
    result["window"]["prior_cumulative_realized_hours"] = 529
    result["window"]["updated_cumulative_realized_hours"] = 530
    ...
    result["active_alpha_context"] = {
        ...
        "reason": (
            "the preregistered own-history compression-breakout entry did not transport "
            "bilaterally: BTC had a favourable OOS point estimate but worse drawdown, weak "
            "fold breadth and uncertainty intervals crossing zero, while ETH materially "
            "underperformed the frozen daily benchmark and finished the full scored sample "
            "negative; therefore this forward interval cannot be used to alter its windows, "
            "inequalities, efficiency normalisation, cadence, fee model or market treatment"
        ),
    }
    ...
    result["next_strategy_action"] = (
        ...
        "public 1H observation; do not prospectively rescue the rejected signed-range "
        "compression-breakout entry family"
    )
