...
import run_prospective_simple_trend_shadow_20260802_0200_realized as prior

PAYOFF_END_OPEN_HOUR_MS = 1_785_636_000_000
...
def write_outputs(output_dir: Path, result: dict[str, Any]) -> None:
    ...
    insertion = (
        ...
        "The 02:00 UTC candle was still forming at acquisition. Only its already fixed opening "
        "price was used as the end of the 01:00–02:00 UTC open-to-open payoff. The incomplete "
        "candle supplied no close, high, low, volume, signal, feature, target or future return. "
        "All signal and 2,160H-history observations remained provider-confirmed completed bars.\n"
    )
...
def run(output_dir: Path, base_url: str) -> dict[str, Any]:
    ...
    result["cutoff_repair"].update(
        {
            "open_endpoint_boundary_repair_applied": True,
            ...
            "diagnostic_workflow_runs": [30729186761, 30729247401],
        }
    )
