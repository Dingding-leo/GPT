...
import run_prospective_simple_trend_shadow_1100 as prior
import run_prospective_simple_trend_shadow_1800 as base

HOUR_MS = prior.HOUR_MS
PREVIOUS_DECISION_HOUR_MS = 1_785_315_600_000  # 2026-07-29T09:00:00Z
REALIZED_DECISION_HOUR_MS = 1_785_319_200_000  # 2026-07-29T10:00:00Z
PRIOR_REPORTED_SIGNAL_HOUR_MS = 1_785_322_800_000  # 2026-07-29T11:00:00Z
LATEST_COMPLETE_SIGNAL_HOUR_MS = 1_785_326_400_000  # 2026-07-29T12:00:00Z
RECENT_WINDOW_FIRST_DECISION_HOUR_MS = 1_785_304_800_000  # 2026-07-29T06:00:00Z
RECENT_WINDOW_LAST_DECISION_HOUR_MS = REALIZED_DECISION_HOUR_MS
PRIOR_RESULT_SHA256 = "ca52a2bd3ff23af58f10a18306b9046280726ad58f2f140a2219074ddff96c27"
PRIOR_ARTIFACT_SHA256 = "0ca902d33015727c730a3480ec7a0aa6e0a9e54f633114b66169df5b9535009e"
...
def write_report(output_dir: Path, result: dict[str, Any]) -> None:
    ...
    lines.extend(
        [
            ...
            "",
            "The frozen 2160H policy was not altered. Issue #625's downside-semivariance "
            "hysteresis trend-carry family is terminally rejected on historical development "
            "evidence and remains prospectively unscored.",
            "",
...
def run(output_dir: Path, base_url: str) -> dict[str, Any]:
    ...
    result["window"]["prior_cumulative_realized_hours"] = 514
    result["window"]["updated_cumulative_realized_hours"] = 515
    result["nomination_status"] = (
        "no_statistically_eligible_strategy_after_downside_semivariance_hysteresis_rejection"
    )
    ...
    result["next_strategy_action"] = (
        ...
        "public 1H observation; separately preregister one own-history-only robust distributed-"
        "slope trend estimator before development inspection"
    )
