...
import run_prospective_simple_trend_shadow_20260729_1800 as prior

HOUR_MS = prior.HOUR_MS
PREVIOUS_DECISION_HOUR_MS = 1_785_340_800_000  # 2026-07-29T16:00:00Z
REALIZED_DECISION_HOUR_MS = 1_785_344_400_000  # 2026-07-29T17:00:00Z
PRIOR_REPORTED_SIGNAL_HOUR_MS = 1_785_348_000_000  # 2026-07-29T18:00:00Z
LATEST_COMPLETE_SIGNAL_HOUR_MS = 1_785_351_600_000  # 2026-07-29T19:00:00Z
RECENT_WINDOW_FIRST_DECISION_HOUR_MS = 1_785_330_000_000  # 2026-07-29T13:00:00Z
RECENT_WINDOW_LAST_DECISION_HOUR_MS = REALIZED_DECISION_HOUR_MS
PRIOR_RESULT_SHA256 = "201ec050ebc279e51aec567b0b16d5ab8783692d41a50c477fe89deb7ad2b620"
PRIOR_ARTIFACT_SHA256 = "a794bbd43def770acbdc7ce0959480ed7cbdbfd0b6bd975e73aaea4475a458d1"
...
def write_report(output_dir: Path, result: dict[str, Any]) -> None:
    ...
    lines.extend(
        [
            ...
            "",
            "Issue #648 and draft PR #649 record terminal historical rejection evidence for "
            "the pooled Bayesian trend-survival onset selector. This interval was not used "
...
def run(output_dir: Path, base_url: str) -> dict[str, Any]:
    ...
    result["window"]["prior_cumulative_realized_hours"] = 521
    result["window"]["updated_cumulative_realized_hours"] = 522
    result["nomination_status"] = "no_statistically_eligible_frozen_strategy"
    result["active_alpha_context"] = {
        "issue": 648,
        "pull_request": 649,
        "family_id": "pooled-bayesian-trend-survival-onset-1h-v1",
        "status": "historical_rejection_evidence_open_draft",
        "prospective_performance_consumed": False,
        "reason": (
            "the preregistered selector failed its training-only conservative posterior gate "
            "and remained cash; prospective scoring cannot be used for threshold relaxation "
            "or rescue tuning"
        ),
    }
    ...
    result["next_strategy_action"] = (
        ...
        "public 1H observation; do not prospectively relax or rescue the rejected pooled "
        "Bayesian trend-survival onset selector"
    )
