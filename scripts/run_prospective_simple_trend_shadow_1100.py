...
import run_prospective_simple_trend_shadow_1000 as prior
import run_prospective_simple_trend_shadow_1800 as base

HOUR_MS = prior.HOUR_MS
PREVIOUS_DECISION_HOUR_MS = 1_785_312_000_000  # 2026-07-29T08:00:00Z
REALIZED_DECISION_HOUR_MS = 1_785_315_600_000  # 2026-07-29T09:00:00Z
PRIOR_REPORTED_SIGNAL_HOUR_MS = 1_785_319_200_000  # 2026-07-29T10:00:00Z
LATEST_COMPLETE_SIGNAL_HOUR_MS = 1_785_322_800_000  # 2026-07-29T11:00:00Z
RECENT_WINDOW_FIRST_DECISION_HOUR_MS = 1_785_301_200_000  # 2026-07-29T05:00:00Z
RECENT_WINDOW_LAST_DECISION_HOUR_MS = REALIZED_DECISION_HOUR_MS
PRIOR_RESULT_SHA256 = "4d02af1c48a7bd7f29254237bdbad4fd83b45adc5eb804631f19b62f1b901cb1"
PRIOR_ARTIFACT_SHA256 = "7f34c4729d99e4188a715519b37a868c0d749cb328234b7b2284fecce8d46887"
...
def write_report(output_dir: Path, result: dict[str, Any]) -> None:
    ...
    lines.extend(
        [
            ...
            "",
            "The frozen 2160H policy was not altered. Issue #622's lagged BTC stress-entry "
            "veto is terminally rejected on historical development evidence and remains "
...
def run(output_dir: Path, base_url: str) -> dict[str, Any]:
    ...
    result["window"]["prior_cumulative_realized_hours"] = 513
    result["window"]["updated_cumulative_realized_hours"] = 514
    result["nomination_status"] = (
        "no_statistically_eligible_strategy_after_lagged_btc_stress_veto_rejection"
    )
    ...
    result["next_strategy_action"] = (
        ...
        "public 1H observation; separately preregister one own-history-only downside-"
        "semivariance hysteresis trend-carry architecture before development inspection"
    )
