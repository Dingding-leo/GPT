...
import run_prospective_simple_trend_shadow_1200 as prior
import run_prospective_simple_trend_shadow_1800 as base

HOUR_MS = prior.HOUR_MS
PREVIOUS_DECISION_HOUR_MS = 1_785_319_200_000  # 2026-07-29T10:00:00Z
REALIZED_DECISION_HOUR_MS = 1_785_322_800_000  # 2026-07-29T11:00:00Z
PRIOR_REPORTED_SIGNAL_HOUR_MS = 1_785_326_400_000  # 2026-07-29T12:00:00Z
LATEST_COMPLETE_SIGNAL_HOUR_MS = 1_785_330_000_000  # 2026-07-29T13:00:00Z
RECENT_WINDOW_FIRST_DECISION_HOUR_MS = 1_785_308_400_000  # 2026-07-29T07:00:00Z
RECENT_WINDOW_LAST_DECISION_HOUR_MS = REALIZED_DECISION_HOUR_MS
PRIOR_RESULT_SHA256 = "4909e0e11967764dd2930362a88761672b76aea62f4a672f695d31605fcce23f"
PRIOR_ARTIFACT_SHA256 = "514b035eceb9c6b8ea3993ada57bfc9d6d1f4bc023a447067e6100799b511114"
...
def write_report(output_dir: Path, result: dict[str, Any]) -> None:
    ...
    lines.extend(
        [
            ...
            "",
            "The frozen 2160H policy was not altered. Issue #628's robust distributed-slope "
            "trend family is terminally rejected on historical development evidence and remains "
...
def run(output_dir: Path, base_url: str) -> dict[str, Any]:
    ...
    result["window"]["prior_cumulative_realized_hours"] = 515
    result["window"]["updated_cumulative_realized_hours"] = 516
    result["nomination_status"] = (
        "no_statistically_eligible_strategy_after_robust_distributed_slope_rejection"
    )
    ...
    result["next_strategy_action"] = (
        ...
        "public 1H observation; do not prospectively rescue the rejected robust distributed-"
        "slope family"
    )
