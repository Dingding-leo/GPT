...
import run_prospective_simple_trend_shadow_1300 as prior
import run_prospective_simple_trend_shadow_1800 as base

HOUR_MS = prior.HOUR_MS
PREVIOUS_DECISION_HOUR_MS = 1_785_322_800_000  # 2026-07-29T11:00:00Z
REALIZED_DECISION_HOUR_MS = 1_785_326_400_000  # 2026-07-29T12:00:00Z
PRIOR_REPORTED_SIGNAL_HOUR_MS = 1_785_330_000_000  # 2026-07-29T13:00:00Z
LATEST_COMPLETE_SIGNAL_HOUR_MS = 1_785_333_600_000  # 2026-07-29T14:00:00Z
RECENT_WINDOW_FIRST_DECISION_HOUR_MS = 1_785_312_000_000  # 2026-07-29T08:00:00Z
RECENT_WINDOW_LAST_DECISION_HOUR_MS = REALIZED_DECISION_HOUR_MS
PRIOR_RESULT_SHA256 = "dbd3a392ed8adb1395cc8f5c054f3055019f72cda1aad2ea90200353c689c179"
PRIOR_ARTIFACT_SHA256 = "73eee01b5a37e8f9ef7a2349cb962e021794cd30fda1cd27900d4b9905bd045b"
...
def write_report(output_dir: Path, result: dict[str, Any]) -> None:
    ...
    lines.extend(
        [
            ...
            "",
            "The frozen 2160H policy was not altered. PR #632 records historical development "
            "rejection evidence for issue #630's causal range-breakout hysteresis family; the "
            "family remains prospectively unscored and cannot be rescue-tuned with this interval.",
            "",
...
def run(output_dir: Path, base_url: str) -> dict[str, Any]:
    ...
    result["window"]["prior_cumulative_realized_hours"] = 516
    result["window"]["updated_cumulative_realized_hours"] = 517
    ...
    result["next_strategy_action"] = (
        ...
        "public 1H observation; do not prospectively rescue the range-breakout hysteresis family"
    )
