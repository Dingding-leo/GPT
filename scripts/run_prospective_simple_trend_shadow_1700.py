...
import run_prospective_simple_trend_shadow_1600 as prior
import run_prospective_simple_trend_shadow_1800 as base

HOUR_MS = prior.HOUR_MS
PREVIOUS_DECISION_HOUR_MS = 1_785_333_600_000  # 2026-07-29T14:00:00Z
REALIZED_DECISION_HOUR_MS = 1_785_337_200_000  # 2026-07-29T15:00:00Z
PRIOR_REPORTED_SIGNAL_HOUR_MS = 1_785_340_800_000  # 2026-07-29T16:00:00Z
LATEST_COMPLETE_SIGNAL_HOUR_MS = 1_785_344_400_000  # 2026-07-29T17:00:00Z
RECENT_WINDOW_FIRST_DECISION_HOUR_MS = 1_785_322_800_000  # 2026-07-29T11:00:00Z
RECENT_WINDOW_LAST_DECISION_HOUR_MS = REALIZED_DECISION_HOUR_MS
PRIOR_RESULT_SHA256 = "87617b8c845ecc6fde4e035d404d6902e52fb3bd3ff59b9f73e1b228aea19a5c"
PRIOR_ARTIFACT_SHA256 = "7d87e513a6906b6b7d41947eaf2c9495ed28691efe9c6c551631429f739457e9"
...
def write_report(output_dir: Path, result: dict[str, Any]) -> None:
    ...
    lines.extend(
        [
            ...
            "",
            "Issue #642 and closed draft PR #643 record terminal historical rejection evidence "
            "for the volume-weighted directional-persistence entry family. This interval was "
...
def run(output_dir: Path, base_url: str) -> dict[str, Any]:
    ...
    result["window"]["prior_cumulative_realized_hours"] = 519
    result["window"]["updated_cumulative_realized_hours"] = 520
    result["nomination_status"] = "no_statistically_eligible_frozen_strategy"
    result["active_alpha_context"] = {
        "issue": 642,
        "pull_request": 643,
        "family_id": "volume-weighted-directional-persistence-entry-1h-v1",
        "status": "historical_rejection_evidence_closed",
        "prospective_performance_consumed": False,
        "reason": (
            "the closed draft PR records bilateral development rejection evidence; prospective "
    ...
    result["next_strategy_action"] = (
        ...
        "public 1H observation; do not prospectively rescue the rejected volume-weighted "
        "directional-persistence entry family"
    )
