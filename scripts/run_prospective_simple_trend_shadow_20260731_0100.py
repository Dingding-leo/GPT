...
import run_prospective_simple_trend_shadow_20260731_0000 as prior

PREVIOUS_DECISION_HOUR_MS = 1_785_448_800_000  # 2026-07-30T22:00:00Z
REALIZED_DECISION_HOUR_MS = 1_785_452_400_000  # 2026-07-30T23:00:00Z
PRIOR_REPORTED_SIGNAL_HOUR_MS = 1_785_456_000_000  # 2026-07-31T00:00:00Z
LATEST_COMPLETE_SIGNAL_HOUR_MS = 1_785_459_600_000  # 2026-07-31T01:00:00Z
RECENT_WINDOW_FIRST_DECISION_HOUR_MS = 1_785_438_000_000  # 2026-07-30T19:00:00Z
RECENT_WINDOW_LAST_DECISION_HOUR_MS = REALIZED_DECISION_HOUR_MS
PRIOR_RESULT_SHA256 = "ed12d45d5df568b6e3a7355ac8d6361df03f4f6aa00cc1b2346a30639fdf520d"
PRIOR_ARTIFACT_SHA256 = "87a5c1d3f387bedfc7e93635d4a3326fa529fc054c447b7617951e86ce40e947"
...
def write_report(output_dir: Path, result: dict[str, Any]) -> None:
    ...
    for line in report_path.read_text().splitlines():
        if line.startswith("# Prospective simple-trend shadow update through"):
            lines.append("# Prospective simple-trend shadow update through 01:00 UTC on 31 July 2026")
        else:
            lines.append(line)
...
def run(output_dir: Path, base_url: str) -> dict[str, Any]:
    ...
    result["window"]["prior_cumulative_realized_hours"] = 551
    result["window"]["updated_cumulative_realized_hours"] = 552
