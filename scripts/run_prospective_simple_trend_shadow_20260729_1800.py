...
import run_prospective_simple_trend_shadow_1700 as prior
import run_prospective_simple_trend_shadow_1800 as base

HOUR_MS = prior.HOUR_MS
PREVIOUS_DECISION_HOUR_MS = 1_785_337_200_000  # 2026-07-29T15:00:00Z
REALIZED_DECISION_HOUR_MS = 1_785_340_800_000  # 2026-07-29T16:00:00Z
PRIOR_REPORTED_SIGNAL_HOUR_MS = 1_785_344_400_000  # 2026-07-29T17:00:00Z
LATEST_COMPLETE_SIGNAL_HOUR_MS = 1_785_348_000_000  # 2026-07-29T18:00:00Z
RECENT_WINDOW_FIRST_DECISION_HOUR_MS = 1_785_326_400_000  # 2026-07-29T12:00:00Z
RECENT_WINDOW_LAST_DECISION_HOUR_MS = REALIZED_DECISION_HOUR_MS
PRIOR_RESULT_SHA256 = "f94fb9ad8eddfdec48adad2d6df9265393d399779ecc0ad7eb88fa334d8e7561"
PRIOR_ARTIFACT_SHA256 = "0b7b707025eca9444d0f71ed72893bdbc565264bf65090e58176fde34615d8ad"
...
def write_report(output_dir: Path, result: dict[str, Any]) -> None:
    ...
    lines.extend(
        [
            ...
            "",
            "Issue #645 and closed draft PR #646 record terminal historical rejection evidence "
            "for the volume-confirmed trend-onset impulse family. This interval was not used "
...
def run(output_dir: Path, base_url: str) -> dict[str, Any]:
    ...
    result["window"]["prior_cumulative_realized_hours"] = 520
    result["window"]["updated_cumulative_realized_hours"] = 521
    result["nomination_status"] = "no_statistically_eligible_frozen_strategy"
    result["active_alpha_context"] = {
        "issue": 645,
        "pull_request": 646,
        "family_id": "volume-confirmed-trend-onset-impulse-1h-v1",
    ...
    result["next_strategy_action"] = (
        ...
        "public 1H observation; do not prospectively rescue the rejected volume-confirmed "
        "trend-onset impulse family"
    )
