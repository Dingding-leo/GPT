...
import run_prospective_simple_trend_shadow_0800 as prior
import run_prospective_simple_trend_shadow_1800 as base

HOUR_MS = prior.HOUR_MS
PREVIOUS_DECISION_HOUR_MS = 1_785_304_800_000  # 2026-07-29T06:00:00Z
REALIZED_DECISION_HOUR_MS = 1_785_308_400_000  # 2026-07-29T07:00:00Z
PRIOR_REPORTED_SIGNAL_HOUR_MS = 1_785_312_000_000  # 2026-07-29T08:00:00Z
LATEST_COMPLETE_SIGNAL_HOUR_MS = 1_785_315_600_000  # 2026-07-29T09:00:00Z
RECENT_WINDOW_FIRST_DECISION_HOUR_MS = 1_785_294_000_000  # 2026-07-29T03:00:00Z
RECENT_WINDOW_LAST_DECISION_HOUR_MS = REALIZED_DECISION_HOUR_MS
PRIOR_RESULT_SHA256 = "fe0d3c5ca1fe21b0d42d0725b88180a0b6bb62d2be61d23e3a138e5f4c33f5e7"
PRIOR_ARTIFACT_SHA256 = "1e1e3739090186838530acdbeeea5d2a59a7a7e351781dcc8ed03f1282bdf397"
...
def write_report(output_dir: Path, result: dict[str, Any]) -> None:
    ...
    lines.extend(
        [
            ...
            "",
            "Issue #614's volatility-compression trend-acceleration architecture is terminally "
...
def run(output_dir: Path, base_url: str) -> dict[str, Any]:
    ...
    result["window"]["prior_cumulative_realized_hours"] = 511
    result["window"]["updated_cumulative_realized_hours"] = 512
    result["nomination_status"] = (
        "no_statistically_eligible_strategy_after_volatility_compression_rejection"
    )
    result["active_alpha_context"] = {
        "issue": 614,
        "family_id": "volatility-compression-trend-acceleration-1h-v1",
    ...
    result["next_strategy_action"] = (
        ...
        "public 1H observation; separately preregister one own-history-only weekly "
        "phase-conditioned trend-carry architecture before development inspection"
    )
