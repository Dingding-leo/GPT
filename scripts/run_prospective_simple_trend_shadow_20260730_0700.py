...
import run_prospective_simple_trend_shadow_20260730_0600 as prior

HOUR_MS = prior.HOUR_MS
PREVIOUS_DECISION_HOUR_MS = 1_785_384_000_000  # 2026-07-30T04:00:00Z
REALIZED_DECISION_HOUR_MS = 1_785_387_600_000  # 2026-07-30T05:00:00Z
PRIOR_REPORTED_SIGNAL_HOUR_MS = 1_785_391_200_000  # 2026-07-30T06:00:00Z
LATEST_COMPLETE_SIGNAL_HOUR_MS = 1_785_394_800_000  # 2026-07-30T07:00:00Z
RECENT_WINDOW_FIRST_DECISION_HOUR_MS = 1_785_373_200_000  # 2026-07-30T01:00:00Z
RECENT_WINDOW_LAST_DECISION_HOUR_MS = REALIZED_DECISION_HOUR_MS
PRIOR_RESULT_SHA256 = "920bdcda1920f214b0063797c7a1ce5c2caa0d5eff480314672bf61b14055213"
PRIOR_ARTIFACT_SHA256 = "7a581b5e2a1167bba97628fbc24c107c77bdaf7e4f272a4b2ce38a465dc044e3"
...
def write_report(output_dir: Path, result: dict[str, Any]) -> None:
    lines = [
        "# Prospective simple-trend shadow update through 07:00 UTC",
        "",
    ...
    lines.extend(
        [
            ...
            "",
            "Issue #685 and closed draft PR #686 record terminal historical rejection evidence for "
            "the signed-volume-flow persistence risk-state family. This interval was not used to "
...
def run(output_dir: Path, base_url: str) -> dict[str, Any]:
    ...
    result["window"]["prior_cumulative_realized_hours"] = 533
    result["window"]["updated_cumulative_realized_hours"] = 534
    result["nomination_status"] = "no_statistically_eligible_frozen_strategy"
    result["active_alpha_context"] = {
        "issue": 685,
        "pull_request": 686,
        "family_id": "signed-volume-flow-persistence-risk-state-1h-v1",
        "status": "terminal_historical_rejection_evidence_closed_draft",
        "prospective_performance_consumed": False,
        "reason": (
            "the sole preregistered own-history signed-volume-flow persistence candidate did not "
            "transport bilaterally: BTC reduced exposure before profitable continuation and lost "
            "return, Sharpe and edge per turnover, while ETH improved aggregate point estimates "
            "but doubled turnover, remained below the benchmark on edge per turnover, failed fold "
            "and year breadth, retained negative residual Sharpe and failed both dependence-aware "
            "uncertainty lower-bound gates; this forward interval cannot alter its flow window, "
            "weighting, sign convention, exposure fraction, hysteresis, cadence, fee model or "
            "market treatment"
        ),
    }
    ...
    result["next_strategy_action"] = (
        ...
        "public 1H observation; do not prospectively rescue the rejected signed-volume-flow "
        "persistence risk-state family"
    )
