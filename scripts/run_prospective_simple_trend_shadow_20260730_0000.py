...
import run_prospective_simple_trend_shadow_20260729_2300 as prior

HOUR_MS = prior.HOUR_MS
PREVIOUS_DECISION_HOUR_MS = 1_785_358_800_000  # 2026-07-29T21:00:00Z
REALIZED_DECISION_HOUR_MS = 1_785_362_400_000  # 2026-07-29T22:00:00Z
PRIOR_REPORTED_SIGNAL_HOUR_MS = 1_785_366_000_000  # 2026-07-29T23:00:00Z
LATEST_COMPLETE_SIGNAL_HOUR_MS = 1_785_369_600_000  # 2026-07-30T00:00:00Z
RECENT_WINDOW_FIRST_DECISION_HOUR_MS = 1_785_348_000_000  # 2026-07-29T18:00:00Z
RECENT_WINDOW_LAST_DECISION_HOUR_MS = REALIZED_DECISION_HOUR_MS
PRIOR_RESULT_SHA256 = "ec4dbabcaca0ed55185c2addece117733df142c2930d71d7bc84a9cbec8abd9b"
PRIOR_ARTIFACT_SHA256 = "278c7e9300727bbd53890390574f30ac0db4cc8dc349f5c5021488966d56bdf8"
...
def write_report(output_dir: Path, result: dict[str, Any]) -> None:
    lines = [
        "# Prospective simple-trend shadow update through 00:00 UTC",
        "",
    ...
    lines.extend(
        [
            ...
            "",
            "Issue #664 and draft PR #665 record terminal historical rejection evidence for "
            "the slow-trend drawdown-budget sizing family. This interval was not used to score, "
...
def run(output_dir: Path, base_url: str) -> dict[str, Any]:
    ...
    result["window"]["prior_cumulative_realized_hours"] = 526
    result["window"]["updated_cumulative_realized_hours"] = 527
    ...
    result["active_alpha_context"] = {
        ...
        "reason": (
            "the preregistered continuous own-history sizing rule underweighted sustained "
            "positive-trend exposure in both development markets; its saved fees were much "
            "smaller than omitted market return and the candidate failed the frozen bilateral "
            "breadth, residual-Sharpe and moving-block uncertainty gates, so this forward "
            "interval cannot be used to change the volatility scale, exposure map, no-trade "
            "band, cadence or exit priority"
        ),
    }
    ...
    result["next_strategy_action"] = (
        ...
        "public 1H observation; do not prospectively rescue the rejected slow-trend "
        "drawdown-budget sizing family"
    )
