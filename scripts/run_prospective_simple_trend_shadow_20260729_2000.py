...
def write_report(output_dir: Path, result: dict[str, Any]) -> None:
    ...
    lines.extend(
        [
            ...
            "the multi-horizon fractional trend ensemble. This interval was not used to score, "
...
def run(output_dir: Path, base_url: str) -> dict[str, Any]:
    ...
    result["active_alpha_context"] = {
        ...
        "reason": (
            "the preregistered fractional ensemble failed bilateral turnover-efficiency, breadth "
            "and dependence-aware uncertainty gates; prospective scoring cannot be used for rescue tuning"
        ),
    }
