...
import run_prospective_simple_trend_shadow_20260729_1900 as prior

HOUR_MS = prior.HOUR_MS
PREVIOUS_DECISION_HOUR_MS = 1_785_344_400_000  # 2026-07-29T17:00:00Z
REALIZED_DECISION_HOUR_MS = 1_785_348_000_000  # 2026-07-29T18:00:00Z
PRIOR_REPORTED_SIGNAL_HOUR_MS = 1_785_351_600_000  # 2026-07-29T19:00:00Z
LATEST_COMPLETE_SIGNAL_HOUR_MS = 1_785_355_200_000  # 2026-07-29T20:00:00Z
RECENT_WINDOW_FIRST_DECISION_HOUR_MS = 1_785_333_600_000  # 2026-07-29T14:00:00Z
RECENT_WINDOW_LAST_DECISION_HOUR_MS = REALIZED_DECISION_HOUR_MS
PRIOR_RESULT_SHA256 = "10299149fe543fa03b64e65d029fa76cff863e73234753c4283f773e0485c5e2"
PRIOR_ARTIFACT_SHA256 = "006372086d6156fecd7d96f0d03df7b2348e0d2ca274ca03811c3fe0539a05bd"
...
def write_report(output_dir: Path, result: dict[str, Any]) -> None:
    ...
    lines.extend(
        [
            ...
            "",
            "Issue #651 and draft PR #652 record terminal historical rejection evidence for "
            "the multi-horizon fractional trend ensemble. This interval was not used to "
...
def run(output_dir: Path, base_url: str) -> dict[str, Any]:
    ...
    result["window"]["prior_cumulative_realized_hours"] = 522
    result["window"]["updated_cumulative_realized_hours"] = 523
    ...
    result["active_alpha_context"] = {
        ...
        "reason": (
            "the preregistered family failed bilateral return, drawdown, turnover-efficiency, "
            "fold-breadth and paired-block uncertainty gates; this forward interval cannot be "
            "used for horizon, weight, cadence or sizing rescue"
        ),
    }
    ...
    result["next_strategy_action"] = (
        ...
        "public 1H observation; do not prospectively rescue the rejected multi-horizon "
        "fractional trend ensemble"
    )
